    ...
    <>
      <div className='poppins-regular'>
        ...
        <div className='flex mt-10 sm:-mt-14 -ml-4 flex-col-reverse sm:flex-row'>
          <Card />
          <img className='w-[350px] h-[350px] sm:w-[500px] sm:h-[500px] desktop:w-[300px] desktop:h-[300px] ml-auto sm:mr-16 animate-customBounce -mb-0 sm:-mt-16' src={ ethereumImg } alt="eth-img" />
        </div>
      </div>
